  ...
  return (
    <div>
      ...
      <div className="mb-2 sm:mb-3 flex items-center justify-between border-b border-neutral-200 pb-2">
        <span className="text-[10px] sm:text-xs font-medium text-neutral-500">Country</span>
      ...
      <div className="space-y-2 sm:space-y-3">
        {countryData.map((item, index) => (
          <div key={index} className="flex items-center justify-between gap-2">
            <span className="text-xs sm:text-sm text-neutral-800 truncate">{item.country}</span>
